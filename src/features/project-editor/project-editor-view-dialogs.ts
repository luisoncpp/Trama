...
function useStableAiExportDialogState(rootPath: string) {
  ...
  return useMemo(
    /* buildAiExportDialogState */ () => ({
      ...
      setLastError: aiExportState.setLastError,
      setCopyToastMessage: aiExportState.setCopyToastMessage,
    ...
    [
      ...
      aiExportState.setLastError,
      aiExportState.setCopyToastMessage,
