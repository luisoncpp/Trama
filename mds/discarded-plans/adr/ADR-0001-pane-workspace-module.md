...
- Implementation plan: `mds/plan/pane-workspace-implementation-plan.md` (descartado)
- Related deepening candidates (archived): `mds/architecture/deepening-opportunities.md`
- 7 lessons-learned entries about split-pane bugs in `mds/lessons-learned/`