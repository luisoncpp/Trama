...
- Architecture: `mds/architecture/split-pane-coordination.md`
- Switch pane flow: `mds/flows/switch-pane-flow.md`
- Previous (discarded) approach: `mds/adr/ADR-0001-pane-workspace-module.md`
