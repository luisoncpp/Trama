...
| `quill-empty-paragraph-turndown-spacing-artifact.md` | Turndown emits `\n\n  \n\n` for Quill `<p><br></p>`; collapse before spacer normalization or one visual blank becomes `spacer lines=2`; skip clean external reload when disk matches saved snapshot | 2026-06-15 |
