...
Related: `mds/START-HERE.md`, `mds/plan/phase-4-detailed-plan.md`, `mds/lessons-learned/sidebar-path-scoping.md`, `mds/architecture/split-pane-coordination.md`
...
`mds/plan/phase-4-detailed-plan.md` already reserves WS2 for folder operations, but that section is intentionally broad and partially outdated against the current codebase. In the real implementation today:
...
Keep the existing pattern from `mds/lessons-learned/sidebar-path-scoping.md`:
