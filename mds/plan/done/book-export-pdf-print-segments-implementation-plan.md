...
**Date:** 2026-06-04  
**Status:** Complete (moved to `mds/plan/done/` after implementation)  
...
1. `mds/START-HERE.md`
2. `mds/architecture/book-export-architecture.md`
3. `mds/adr/0004-book-pdf-via-html-print-segments.md`
...
Update `mds/live/file-map.md` when files are created/deleted.
...
- [x] `mds/architecture/book-export-architecture.md`: flip “implementación pendiente” → implemented; remove legacy section or move to `mds/plan/done/`
- [x] `mds/live/current-status.md`: PDF uses printToPDF
- [x] `mds/live/file-map.md`: new/deleted files
- [x] `mds/lessons-learned/`: entry if e.g. `data:` URL limits, `printToPDF` margin quirks, merge mutex
...
1. Canonical reference: `mds/architecture/book-export-architecture.md` (Export PDF + debug playbook).
2. PDF layout gotchas: `mds/lessons-learned/book-export-pdf-print-surface.md`.
