...
| `mds/plan/incremental-project-update-plan.md` | Create | This document |

## Related Documents

- `mds/architecture/project-index-architecture.md`
- `mds/flows/project-state-propagation-flow.md`
- `mds/flows/folder-delete-flow.md`
- `mds/flows/external-file-watcher-flow.md`
