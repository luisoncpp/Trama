...
- `mds/architecture/rich-markdown-editor-core-architecture.md` — existing core flow
- `mds/architecture/image-handling-architecture.md` — why serialization is expensive
- `mds/architecture/editor-serialization-debounce-architecture.md` — full data flow, ref mutation strategy, per-pane isolation, flush callers table
- `mds/lessons-learned/turndown-base64-replacement-performance.md` — performance context
- `mds/lessons-learned/editor-debounce-closure-capture.md` — why closures beat refs in debounce timers
