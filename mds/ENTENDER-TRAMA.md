...
4. Referencia canónica: `mds/architecture/split-pane-coordination.md`.
...
1. Mira `mds/flows/` si es una secuencia de acciones ("qué pasa cuando hago X").
2. Mira `mds/lessons-learned/` si es un comportamiento raro o contra-intuitivo.
3. Mira `mds/architecture/` si necesitas entender el diseño completo de un subsistema.
