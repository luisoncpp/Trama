...
Implementation guide: `mds/wiki-tag-links-implementation-plan.md`
System guide + debug playbook: `mds/wiki-tag-links-system-guide.md`
...
| `mds/live/file-map.md` | Register new files |
| `mds/live/current-status.md` | Update phase status |
