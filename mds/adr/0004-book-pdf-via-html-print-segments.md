...
Status: accepted (implemented 2026-06-04; see `mds/architecture/book-export-architecture.md`)
...
See `mds/architecture/book-export-architecture.md` for the full pipeline.
