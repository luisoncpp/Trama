...
- Main sidebar architecture: `mds/architecture/sidebar-architecture.md`
- Path scoping lesson: `mds/lessons-learned/sidebar-path-scoping.md`
- Folder rename remapping: `mds/lessons-learned/folder-rename-split-layout-remap.md`
- Split pane sidebar coordination: `mds/lessons-learned/split-pane-sidebar-layout-vs-pane-path.md`
