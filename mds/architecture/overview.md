...
### IPC Layer (`mds/architecture/ipc-architecture.md`)
...
### Project Index (`mds/architecture/project-index-architecture.md`)
...
### Sidebar (`mds/architecture/sidebar-architecture.md`)
...
### Rich Editor (`mds/architecture/rich-markdown-editor-core-architecture.md`)
...
### Split Pane (`mds/architecture/split-pane-coordination.md`)
...
### Focus Mode (`mds/architecture/focus-mode-architecture.md`)
...
### Wiki Tag Links (`mds/architecture/wiki-tag-links-architecture.md`)
...
### AI Import/Export (`mds/architecture/ai-import-export-architecture.md`)
...
### Application Menu (`mds/architecture/application-menu-architecture.md`)
...
### Spellcheck (`mds/architecture/spellcheck-architecture.md`)
...
### Book Export (`mds/architecture/book-export-architecture.md`)
...
- `mds/START-HERE.md` — documentation entry point and fast routing
- `mds/live/current-status.md` — implemented vs pending features
- `mds/live/file-map.md` — file ownership and where to edit
- `mds/lessons-learned/README.md` — accumulated lessons from bugs and fixes
- `mds/dev-workflow.md` — build/test/checklist rules
