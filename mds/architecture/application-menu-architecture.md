...
Trama's zoom is documented in `mds/architecture/editor-zoom-architecture.md`.
...
- `mds/architecture/editor-zoom-architecture.md` — Trama's custom zoom implementation
- `mds/architecture/rich-editor-hotspots.md` — Editor command bridge via context menu
- `mds/live/file-map.md` — File ownership
