...
- `mds/architecture/rich-markdown-editor-core-architecture.md`
...
- `mds/flows/rich-editor-external-sync-flow.md`
...
- `mds/architecture/split-pane-coordination.md`
- `mds/lessons-learned/split-pane-sidebar-layout-vs-pane-path.md`
...
| "Images disappear after edit" | Canonical external-value sync or placeholder-markdown leaked into parent state → `mds/lessons-learned/editor-onchange-image-hydration.md` |
