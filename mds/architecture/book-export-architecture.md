...
4. Si hay **página en blanco al inicio** en un segmento de portada:
   ...
   - Ver `mds/lessons-learned/book-export-pdf-print-surface.md`.
...
8. Síntomas comunes (márgenes, página en blanco): `mds/live/troubleshooting.md` §14.
...
5. Agregar entrada en `mds/live/file-map.md`
