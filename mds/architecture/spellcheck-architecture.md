...
See: `mds/lessons-learned/spellcheck-optimistic-toggle-sync.md`
...
See: `mds/lessons-learned/rich-editor-effect-deps-remount.md`
...
See: `mds/lessons-learned/electron-spellcheck-settings.md`
...
- IPC architecture: `mds/architecture/ipc-architecture.md`
- Rich editor core architecture: `mds/architecture/rich-markdown-editor-core-architecture.md`
- Lessons: `mds/lessons-learned/spellcheck-optimistic-toggle-sync.md`, `mds/lessons-learned/electron-spellcheck-settings.md`, `mds/lessons-learned/rich-editor-effect-deps-remount.md`
