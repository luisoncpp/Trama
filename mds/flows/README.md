...
Use `mds/flows/` when you need to follow behavior end-to-end from a trigger instead of from a subsystem boundary.
...
| `global-search-result-find-flow.md` | What happens when a sidebar Search result opens a file and transfers the query into the local find bar |
