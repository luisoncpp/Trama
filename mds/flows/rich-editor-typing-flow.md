...
| `mds/lessons-learned/editor-debounce-closure-capture.md` | Non-obvious debounce invariants |
| `mds/lessons-learned/quill-render-keypress-image-loss.md` | Canonical image representation rule |
| `mds/architecture/rich-editor-hotspots.md` | Fast routing if the symptom maps better to a known fragile seam |
| `mds/flows/rich-editor-external-sync-flow.md` | Follow the later decision to re-apply or skip incoming values |
...
- `mds/architecture/rich-editor-hotspots.md` -> `Debounced serialization`
