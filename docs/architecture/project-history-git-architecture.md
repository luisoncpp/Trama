...
- Spec: `docs/spec/project-history-git-spec.md`
- Plan: `docs/plan/project-history-git-implementation-plan.md`
- ADR: `docs/adr/0001-restore-revision-images-for-fidelity.md`
- Lesson: `docs/lessons-learned/revision-preview-should-use-explicit-read-only-mode.md`
