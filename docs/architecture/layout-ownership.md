...
- `docs/architecture/sidebar-architecture.md`
- `docs/architecture/focus-mode-architecture.md`
- `docs/architecture/split-pane-coordination.md`
- `docs/lessons-learned/sidebar-width-responsive-collapse-sync.md`
- `docs/lessons-learned/focus-mode-css-grid-display-none-auto-place.md`
- `docs/lessons-learned/map-editor-rendering-quirks.md`
