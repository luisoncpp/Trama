...
Help HTML screenshots are generated offline via `npm run help:screenshots` (Electron `capturePage` against `example-fantasy/`); see Slice 3b in `docs/plan/help-menu-implementation-plan.md`.

See `docs/plan/help-menu-implementation-plan.md` and (once implemented) `docs/architecture/help-window-architecture.md`.
