...
(window)    (auto-open)  (chrome)    (content)   (advanced)  (docs)
```
...
6. **Keyboard shortcuts** — table summarizing `docs/architecture/keyboard-shortcuts-architecture.md`
...
Author content from `docs/START-HERE.md` 90-second summary and linked architecture docs. Do not duplicate developer setup from root `README.md`.
...
|------|------------------------|
| `maps.html` | `docs/architecture/map-document-architecture.md`, `docs/spec/map-document-markers-spec.md` |
| `wiki-tags.html` | `docs/architecture/wiki-tag-links-architecture.md` |
| `ai-import-export.html` | `docs/architecture/ai-import-export-architecture.md` |
| `book-export.html` | `docs/architecture/book-export-architecture.md` |
| `git-snapshots.html` | `docs/architecture/project-history-git-architecture.md`, `CONTEXT.md` Snapshot terms |
...
- [ ] Create `docs/architecture/help-window-architecture.md` (canonical post-implementation reference)
...
- [ ] Update `docs/architecture/application-menu-architecture.md` (Help submenu, remove `{ role: 'help' }`)
- [ ] Update `docs/live/file-map.md`
- [ ] Update `docs/live/current-status.md` when feature ships
- [ ] Add `docs/START-HERE.md` routing row
- [ ] Add `docs/lessons-learned/` entry if cross-window `localStorage` bridge surprises future work

## Files to add or change

| File | Action |
|------|--------|
| `docs/adr/0005-help-window-bundled-html.md` | Done |
| `docs/plan/help-menu-implementation-plan.md` | This file |
| `docs/architecture/help-window-architecture.md` | Create in Slice 1 |
...
- `docs/architecture/application-menu-architecture.md` — menu bar (update in Slice 6)
- `docs/architecture/keyboard-shortcuts-architecture.md` — shortcut table source
- `docs/architecture/theme-architecture.md` — theme resolution for handoff
