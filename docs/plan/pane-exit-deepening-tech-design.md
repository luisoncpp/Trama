...
Related: `CONTEXT.md`, `docs/adr/0002-pane-exit-lives-in-paneworkspace.md`, `docs/architecture/split-pane-coordination.md`, `docs/architecture/editor-serialization-debounce-architecture.md`, `docs/flows/rich-editor-revert-changes-flow.md`
