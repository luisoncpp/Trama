...
Date: 2026-06-01
Status: Implemented
Depends on: `docs/adr/0002-pane-exit-lives-in-paneworkspace.md`, `docs/plan/pane-exit-deepening-tech-design.md`
...
1. `docs/architecture/split-pane-coordination.md`
2. `docs/architecture/editor-serialization-debounce-architecture.md`
3. `docs/flows/rich-editor-revert-changes-flow.md`
4. `docs/live/file-map.md` if any new TS/TSX file is created
5. `docs/lessons-learned/README.md` plus a new lesson file if implementation reveals a counter-intuitive persistence fact
