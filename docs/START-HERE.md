...
| Investigate `useProjectEditor()` reruns on typing | `docs/plan/use-project-editor-keystroke-churn-plan.md` → `src/features/project-editor/pane/rich-markdown-editor/rich-markdown-editor-serialization.ts` → `src/features/project-editor/pane/pane-workspace.ts` → `src/features/project-editor/use-project-editor.ts` |
