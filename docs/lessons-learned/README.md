...
| `focus-mode-rich-markdown-highlighting.md` | Focus mode became stable only after using CSS Highlights API first, geometry fallback second, and avoiding structural DOM mutations inside Quill editor content | 2026-04-05 |
