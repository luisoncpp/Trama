...
| `quill-centered-images-need-block-level-centering.md` | Center directives in Quill must center descendant images explicitly with block-level CSS; `text-align` alone is not enough | 2026-05-11 |
