...
| `sidebar-shell-width-must-be-pinned.md` | Sidebar width preferences must constrain the shell with `width` + `min-width` + `max-width`, or section content can make rail switches appear to resize the sidebar | 2026-05-23 |
